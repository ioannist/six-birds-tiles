...
which the profile was built (\cref{sec:solid}), so every finite substitution patch is a packing
...
carried to a tiling by $\solid$ by the glued tube homeomorphism of \cref{sec:solid}, each chair
