...
tube construction and carrier recovery in \cref{sec:solid}, realization in \cref{sec:existence},
...
compiler hooks; the written proofs of \cref{sec:solid,sec:existence} and
...
\begin{figure}[ht]
  \centering
  \input{generated/fig_coincidence}
