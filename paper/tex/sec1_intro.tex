...
\cref{app:solidchecks,sec:finding,sec:companions,sec:registration} are themselves Lean theorems, so that
...
stabilizer of its family of placements; the two coincide when the tile has no nonidentity self-isometry, as
$\solid$ has none (\cref{app:asymmetry}), and we write $\Sym(T)$ throughout.
