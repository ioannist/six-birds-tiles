...
\date{15 September 2026 (review version; mathematical baseline commit \texttt{d90313a717}; intended release tag \texttt{paper-v1})}
...
\IfFileExists{publication_doi.tex}{\input{publication_doi}}{}

\input{sec1_intro}
\input{sec2_solid}
\input{sec3_finding}
\input{sec4_companions}
\input{sec5_registration}
\input{sec6_hierarchy}
\input{sec7_aperiodicity}
\input{sec8_mechanization}
\clearpage
\input{sec9_context}
\input{sec9_remarks}
